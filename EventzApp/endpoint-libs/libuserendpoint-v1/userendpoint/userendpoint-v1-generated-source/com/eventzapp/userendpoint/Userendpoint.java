...
package com.eventzapp.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.eventzapp.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.eventzapp.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.eventzapp.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.eventzapp.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.eventzapp.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.eventzapp.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.eventzapp.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.eventzapp.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.eventzapp.userendpoint.model.CollectionResponseUser.class);
    }
  ...
  public class RemoveUser extends UserendpointRequest<com.eventzapp.userendpoint.model.User> {
    ...
    protected RemoveUser(java.lang.Long id) {
      super(Userendpoint.this, "DELETE", REST_PATH, null, com.eventzapp.userendpoint.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.eventzapp.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.eventzapp.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.eventzapp.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.eventzapp.userendpoint.model.User.class);
    }
